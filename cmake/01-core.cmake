...
option(BUILD_MAPREDUCE "Build the main map-reduce executable" ${DEFAULT_ON})
option(BUILD_MAPREDUCE_MSG "Build map-reduce-msg" ${DEFAULT_ON})
...
if (BUILD_MAPREDUCE OR BUILD_TESTS)
  set(BUILD_LIBPOLY ON)
else()
  set(BUILD_LIBPOLY OFF)
endif()

if (BUILD_LIBPOLY OR BUILD_MAPREDUCE_MSG)
